...
Random forest models were built in GEE. Thus processing of predictors, interfacing with the MapBiomas platform, and construction of random forest models is carried out using code presenet in the GEE folder. 
