...
///add the data to GEE from assets showing single-year opp cost from Strassburg et al 2020  
...
//resample Strassburg et al to correct resolution 
var opppast = opppast
      // Force the next reprojection to aggregate instead of resampling.
    .reduceResolution({
      reducer: ee.Reducer.mean(),
...
var oppcost_10km = opppast_anual.add(opcrop_anual).divide(ee.Number(2))
