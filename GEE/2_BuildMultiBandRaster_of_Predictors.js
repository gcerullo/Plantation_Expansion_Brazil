...
//============================================================================================
 var plantation = ee.Image('users/GRC95/10km_analysis/plantation_1Okm');
 var oppcost = ee.Image('users/GRC95/10km_analysis/10km_anual_opportunity_cost');
 var buffer5 = ee.Image('users/GRC95/10km_analysis/50km_buffer_plantation');
 var buffer10 = ee.Image('users/GRC95/10km_analysis/100km_buffer_plantation');
 var eucalypt = ee.Image('users/GRC95/10km_analysis/10km_eucalypt');  //biophysical suitability
